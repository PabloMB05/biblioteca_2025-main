...
import { Floor, useDeleteFloor, useFloors } from "@/hooks/floor/useFloor";
...
export default function FloorsIndex() {
  ...
  const combinedSearch = [
    filters.search,
    filters.floor_number ? `floor_number:${filters.floor_number}` : null,
  ].filter(Boolean).join(' ');
          ...
          <div className="space-y-4">
            <FiltersTable
              filters={[
                {
                  id: 'floor_number',
                  label: t('ui.floors.filters.floor_number') || 'Floor Number',
                  type: 'text',
                  placeholder: t('ui.floors.placeholders.floor_number') || 'Floor number...',
                },
                {
                  id: 'capacity',
