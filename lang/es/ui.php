...
return [
    ...
    'reservations' => [
        'title' => 'Reservas',
        'no_results'=> 'No hay resultados de reservas',
        'filters' => [
        ...
        'utils'=> [
            'select_email'=> 'Selecciona un email de usuario',
            'required_fileds'=> 'Email de usuario obligatorio',
            'search_email'=> 'Busca Email',
    ...
    'loans' => [
        'title' => 'Préstamos',
        'no_results'=> 'No hay resultados de préstamos',
        'create' => 'Crear Préstamo',
        'edit'=> 'Editar Préstamo',
        'delete'=>[
            'title'=> 'Eliminar Préstamo',
            'description'=> '¿Está seguro de eliminar este préstamo? Esta acción no se puede deshacer.',
        ],
        'buttons' => [
            'new' => 'Nuevo Préstamo',
        ],
        ...
        'placeholders' => [
            'book'=> 'Book ISBN',
            'booktitle' => 'Ingrese título del libro...',
        ...
        'cards' => [
            ...
            'edit'=> [
                ...
                'description'=> 'Cambie los datos para actualizar el préstamo',
            ],
        ],
        ...
        'buttons' => [
            ...
            'delayOneWeek' => 'Aumentar una semana',
            'edit'=> 'Editar',
            'delete'=> 'borrar',
        ],
    ],
    ...
    'validation' => [
        ...
        'userEmail'=> 'Introduce una dirección de email válida',
        'min' => [
    ...
    'floors' => [
        ...
        'delete' => [
            ...
            'description' => '¿Estás seguro de que deseas eliminar este piso? Esta acción no se puede deshacer.',
        ],
    ...
    'bookcases' => [
        ...
        'no_results'=> 'No hay resultados de estanterías',        
    ...
    'zones' => [
        ...
        'placeholders' => [
            'number' => 'Introduce el número...',
            'capacity' => 'Introduce la capacidad...',
            'floor'=> 'Introduce el número del piso...',
            'genre'=> 'Selecciona un genero',
        ],
        'columns' => [
            'number' => 'Número de zona',
            'capacity' => 'Capacidad',
    ...
    'books' => [
        ...
        'permissions' => [
            ...
            'delete'=>[
                ...
                'description' => '¿Estás seguro de que deseas eliminar este libro? Esta acción no se puede deshacer.',
            ],
        ],
        'roles' => [
            'default' => 'Seleccione un Rol',
    ...
    'records' => [
        ...
        'timeline'=>[
            'all'=> 'Reservas y Prestamos',
            'none'=> 'No hay reservas ni préstamos registrados',
            'info'=> 'Cuando solicites un préstamo y reserva, aparecerá aquí.'
        ],
    ],
    'genres' => [
    'label' => [
